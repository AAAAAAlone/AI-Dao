...
// New types for structured intentions
export interface TrigramDetail {
  ...
  people: string;
  body: string;
  categorySpecial: Partial<Record<CategoryKey, string>>;
}

export interface LiuqinDetail {
  general: string;
  categorySpecial: Record<CategoryKey, string>;
}

export interface SixGodDetail {
  general: string;
  categorySpecial: Record<CategoryKey, string>;
}
